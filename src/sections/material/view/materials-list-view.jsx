...
export function MaterialsListView() {
  ...
  const handleDeleteRow = useCallback(
    async (id) => {
      try {
        const result = await deleteMaterial(organizationId, id);
  ...
  const handleDeleteRows = useCallback(async () => {
    try {
      ...
      const deletePromises = selectedRowIds.map((id) => deleteMaterial(organizationId, id));
  ...
  const handleToggleStatus = useCallback(
    async (id) => {
      try {
        ...
        const result = await toggleMaterialStatus(organizationId, id, newStatus);
