...
export const paths = {
  ...
  dashboard: {
    ...
    invite: {
      root: `${ROOTS.DASHBOARD}/invite`,
      list: `${ROOTS.DASHBOARD}/invite/list`,
    },
    role: {
    ...
    workflows: {
      ...
      new: `${ROOTS.DASHBOARD}/workflows/new`,
      edit: (id) => `${ROOTS.DASHBOARD}/workflows/${id}/edit`,
    },
    forms: {
    ...
    workflowRequests: {
      root: `${ROOTS.DASHBOARD}/workflow-requests`,
      new: `${ROOTS.DASHBOARD}/workflow-requests/new`,
      pending: `${ROOTS.DASHBOARD}/workflow-requests/pending`,
    },
    workflowSlas: {
      root: `${ROOTS.DASHBOARD}/workflow-slas`,
    },
    businessPartners: {
      root: `${ROOTS.DASHBOARD}/business-partners`,
