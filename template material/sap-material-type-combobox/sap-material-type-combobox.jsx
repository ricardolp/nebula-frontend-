...
import { SAP_MATERIAL_TYPE_OPTIONS, searchSapMaterialTypeOptions, getSapMaterialTypeLabel } from './sap-material-type-constants';

// ----------------------------------------------------------------------

/**
 * Combobox para seleção de tipos de material SAP
 * 
 * @param {Object} props
 * @param {string} props.value - Valor selecionado (código do tipo de material)
 ...
 */
export function SapMaterialTypeCombobox({
  value,
  onChange,
  ...
  const options = useMemo(() => {
    ...
    return searchSapMaterialTypeOptions(searchTerm);
  }, [filteredOptions, searchTerm]);

  // Valor atual formatado para o Autocomplete
  const currentValue = useMemo(() => {
    if (!value) return null;
    return SAP_MATERIAL_TYPE_OPTIONS.find(option => option.value === value) || null;
  }, [value]);
 ...
 */
export function useSapMaterialTypeCombobox() {
  return {
    getLabel: getSapMaterialTypeLabel,
    searchOptions: searchSapMaterialTypeOptions,
    allOptions: SAP_MATERIAL_TYPE_OPTIONS,
  };
}
